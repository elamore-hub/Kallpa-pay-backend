...
export interface IAccountKallpaPay {
  id?: number;
...
export class AccountKallpaPay implements IAccountKallpaPay {
  constructor(
    public id?: number,
...
export function getAccountKallpaPayIdentifier(accountKallpaPay: IAccountKallpaPay): number | undefined {
  return accountKallpaPay.id;
}
