...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'account-kallpa-pay',
        data: { pageTitle: 'kallpapayApp.accountKallpaPay.home.title' },
        loadChildren: () => import('./account-kallpa-pay/account-kallpa-pay.module').then(m => m.AccountKallpaPayModule),
      },
      {
