...
public class AccountHolder implements Serializable {
    ...
    private Set<AccountKallpaPay> accountKallpaPays = new HashSet<>();
    ...
    public Set<AccountKallpaPay> getAccountKallpaPays() {
        return this.accountKallpaPays;
    }

    public void setAccountKallpaPays(Set<AccountKallpaPay> accountKallpaPays) {
        if (this.accountKallpaPays != null) {
            this.accountKallpaPays.forEach(i -> i.setAccountHolder(null));
        }
        if (accountKallpaPays != null) {
            accountKallpaPays.forEach(i -> i.setAccountHolder(this));
        }
        this.accountKallpaPays = accountKallpaPays;
    }

    public AccountHolder accountKallpaPays(Set<AccountKallpaPay> accountKallpaPays) {
        this.setAccountKallpaPays(accountKallpaPays);
        return this;
    }

    public AccountHolder addAccountKallpaPay(AccountKallpaPay accountKallpaPay) {
        this.accountKallpaPays.add(accountKallpaPay);
        accountKallpaPay.setAccountHolder(this);
        return this;
    }

    public AccountHolder removeAccountKallpaPay(AccountKallpaPay accountKallpaPay) {
        this.accountKallpaPays.remove(accountKallpaPay);
        accountKallpaPay.setAccountHolder(null);
        return this;
    }
