...
public class AccountMembership implements Serializable {
    ...
    public AccountKallpaPay getAccountKallpaPay() {
        return this.accountKallpaPay;
    }

    public void setAccountKallpaPay(AccountKallpaPay accountKallpaPay) {
        this.accountKallpaPay = accountKallpaPay;
    }

    public AccountMembership accountKallpaPay(AccountKallpaPay accountKallpaPay) {
        this.setAccountKallpaPay(accountKallpaPay);
        return this;
    }
