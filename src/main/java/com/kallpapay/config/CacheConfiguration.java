...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.kallpapay.domain.AccountHolder.class.getName() + ".accountKallpaPays");
            ...
            createCache(cm, com.kallpapay.domain.AccountKallpaPay.class.getName());
            createCache(cm, com.kallpapay.domain.AccountKallpaPay.class.getName() + ".accountMemberships");
            createCache(cm, com.kallpapay.domain.AccountKallpaPay.class.getName() + ".iBANS");
            createCache(cm, com.kallpapay.domain.AccountKallpaPay.class.getName() + ".transactions");
